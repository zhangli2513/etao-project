...
new corouselView.Corouse("#center-course",[{imagePath:"img/header/photomax1.jpg"},{imagePath:"img/header/photomax2.jpg"}],752,400).putSuperView().startTimer(3000,function(){
